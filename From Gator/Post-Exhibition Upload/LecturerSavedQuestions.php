            ...
            <div class="panel">
                    <table>';
                      ...
                      echo '<tr>
                        ...
                        <td id="Border"><a href="QuestionMethods.php?edit&'. $result1['id'] .'" style="color:#2196f3;font-weight: bold;">Edit</a></td>
                        <td id="NoBorder"><a href="QuestionMethods.php?delete&'. $result1['id'] .'" style="color:#d50000 ;font-weight: bold;">Delete</a></td>
                      </tr>';
                    };
                    echo '
                </table>
