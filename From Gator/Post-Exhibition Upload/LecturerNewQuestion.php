   ...
   <!-- Always shows a header, even in smaller screens. -->
    ...
    <div id="MainContainer"> 
        <div id="NameContainer">
            ...
            <div id="qNameSelect"> 
                <input id="NameTfield" type="text" name="name" value="">
            </div>
        </div>

     <div id="qTopicContainer">
        <div id="qTopic" style="margin: auto; width: 50%;">
            <p>Under the topic:</p>
        </div>

        <div id="qTopicSelect">
            <input id="text-to-add" type="text" placeholder="New topic name (optional)" >
	    <button type="button" id="new-item">Add to topics</button>
            <select id="Topsel" name="topic">';
                $count = 1;
        ...
        <div id="qTypeContainer">
            ...
            <div id="qTypeSelect">
                    <select id="Typesel" name="type" onchange="myFunction()">
    ...
    <div id="AnswerContainer"> 
            ...
            <p id="AnswerText"><b>Upload the answer via an image or type above: &nbsp;</b></p>
    </div>
