...
$stmt = $pdo->prepare("SELECT DISTINCT user FROM users WHERE status='student'");
$stmt->execute();
...
<head>
 ...
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css" integrity="sha384-/Y6pD6FV/Vv2HJnA6t+vslU6fwYXjCFtcEpHbNJ0lyAFsXTsjBbfaDjzALeQsN6M" crossorigin="anonymous">
  ...
  <link rel="stylesheet" href="https://code.getmdl.io/1.3.0/material.indigo-pink.min.css">
    ...
    <link rel="stylesheet" href="StudentPerformance.css">
...
<body>
    ...
    <div id="TestContainer">
        <div id="TestName">
            <p>Select the name of the student you want to compare:</p>
...
function drawgraph(){
    ...
    $.ajax({
        url: "graphdata.php",
        data: {username: $("#Namesel").val(), method: "userinfo"},
        dataType: "json",
